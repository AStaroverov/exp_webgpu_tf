...
export const STONE_COLORS: TColor[] = [
    new Float32Array([0.35, 0.33, 0.30, 1]),
    new Float32Array([0.42, 0.40, 0.36, 1]),
    new Float32Array([0.38, 0.35, 0.32, 1]),
    new Float32Array([0.45, 0.42, 0.38, 1]),
    new Float32Array([0.32, 0.30, 0.28, 1]),
    new Float32Array([0.40, 0.38, 0.35, 1]),
    new Float32Array([0.48, 0.45, 0.40, 1]),
    new Float32Array([0.36, 0.34, 0.30, 1]),
];
