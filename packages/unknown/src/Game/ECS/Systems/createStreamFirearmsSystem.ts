...
import { ALL_VEHICLE_PARTS_MASK, StreamCaliberConfig, StreamParticleLightConfig } from '../../Config/index.ts';
...
export function createStreamFirearmsSystem({ world } = GameDI) {
    const {
        VehicleTurret, TurretController, StreamFirearms, SpawnDeltaPosition, Damagable, Dotable, SensorHits, DestroyByTimeout,
        RigidBodyRef, RigidBodyState, PlayerRef, TeamRef, Parent, VFX, Progress, Wander, Shape, Color, LightEmitter,
