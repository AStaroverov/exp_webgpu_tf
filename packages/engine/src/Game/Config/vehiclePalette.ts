...
export const VEHICLE_PALETTES: VehiclePalette[] = [
  ...
  { hull: rgb(0.8, 0.82, 0.85), turret: rgb(0.72, 0.36, 0.18), tracks: rgb(0.12, 0.12, 0.13) }, // light gray / rust
  { hull: rgb(0.58, 0.62, 0.26), turret: rgb(0.46, 0.3, 0.6), tracks: rgb(0.12, 0.12, 0.11) }, // olive / purple
  { hull: rgb(0.82, 0.64, 0.42), turret: rgb(0.28, 0.4, 0.64), tracks: rgb(0.12, 0.13, 0.14) }, // tan / slate-blue
  { hull: rgb(0.56, 0.82, 0.66), turret: rgb(0.48, 0.3, 0.18), tracks: rgb(0.1, 0.13, 0.11) }, // mint / brown
  { hull: rgb(0.94, 0.66, 0.5), turret: rgb(0.26, 0.28, 0.32), tracks: rgb(0.1, 0.1, 0.11) }, // peach / charcoal
  { hull: rgb(0.46, 0.62, 0.76), turret: rgb(0.92, 0.86, 0.64), tracks: rgb(0.11, 0.13, 0.15) }, // steel-blue / cream
  { hull: rgb(0.74, 0.68, 0.82), turret: rgb(0.2, 0.42, 0.26), tracks: rgb(0.12, 0.12, 0.13) }, // lavender / dark green
];
...
export const TEAM_BASE_COLORS: Record<number, Float32Array> = {
  1: new Float32Array([0.9, 0.2, 0.2, 1]), // red
  2: new Float32Array([0.2, 0.45, 0.95, 1]), // blue
  3: new Float32Array([0.25, 0.8, 0.3, 1]), // green
  4: new Float32Array([0.95, 0.8, 0.15, 1]), // yellow
};
