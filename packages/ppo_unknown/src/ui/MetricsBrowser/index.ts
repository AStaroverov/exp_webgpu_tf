    ...
    if (key === "logit") {
      ...
      channel.onmessage = w((event) => {
        (
          ...
          const k =
            `successRatio${scenarioIndex}${isReference ? "Ref" : "Train"}` as keyof typeof store;
          if (k in store) store[k].add(successRatio);
        });
      });
    } else {
      channel.onmessage = w((event) => {
...
function buildPanel(): HTMLElement {
  ...
  for (let i = 0; i < scenariosCount; i++) {
    ...
    addChartToGrid(grid, `Scenario ${i}`, [
      {
        getData: () => store[`successRatio${idx}Train`].toArray(),
        color: "#4a9eff",
        label: "Train",
        dot: true,
      },
      {
        getData: () => movingAvg(store[`successRatio${idx}Train`].toArray(), 20),
        color: "#ff6b6b",
        label: "Train MA",
        width: 2,
      },
      {
        getData: () => store[`successRatio${idx}Ref`].toArray(),
        color: "#51cf66",
        label: "Ref",
        dot: true,
      },
      {
        getData: () => movingAvg(store[`successRatio${idx}Ref`].toArray(), 20),
        color: "#ffd43b",
        label: "Ref MA",
        width: 2,
      },
  ...
  addChartToGrid(grid, "KL", [
    ...
    {
      getData: () => movingMedian(store.kl.toArray(), 25),
      color: "#ff6b6b",
      label: "Median",
      width: 2,
    },
  ...
  addChartToGrid(grid, "Entropy H(π)", [
    ...
    {
      getData: () => movingAvg(store.entropy.toArray(), 20),
      color: "#ff6b6b",
      label: "MA",
      width: 2,
    },
  ...
  addChartToGrid(grid, "V-Trace Explained Variance", [
    ...
    {
      getData: () => constLine(store.vTraceExplainedVariance.toArray(), 0.65),
      color: "#ffd43b",
      label: "0.65",
      dashed: true,
    },
    {
      getData: () => constLine(store.vTraceExplainedVariance.toArray(), 0.75),
      color: "#ff6b6b",
      label: "0.75",
      dashed: true,
    },
  ...
  addChartToGrid(grid, "V-Trace σ(V)/σ(R)", [
    ...
    {
      getData: () => constLine(store.vTraceStdRatio.toArray(), 0.8),
      color: "#ffd43b",
      label: "0.8",
      dashed: true,
    },
    {
      getData: () => constLine(store.vTraceStdRatio.toArray(), 1.2),
      color: "#ff6b6b",
      label: "1.2",
      dashed: true,
    },
  ...
  addChartToGrid(grid, "Advantage", [
    ...
    {
      getData: () => movingAvg(store.advantages.toArray(), 1000),
      color: "#ff6b6b",
      label: "MA",
      width: 2,
    },
  ...
  addChartToGrid(grid, "Train Time", [
    ...
    {
      getData: () => movingAvg(store.trainTime.toArray(), 100),
      color: "#ff6b6b",
      label: "MA",
      width: 2,
    },
  ...
  addChartToGrid(grid, "Wait Time", [
    ...
    {
      getData: () => movingAvg(store.waitTime.toArray(), 100),
      color: "#ff6b6b",
      label: "MA",
      width: 2,
    },
  ...
  addChartToGrid(grid, "Batch Version Delta", [
    ...
    {
      getData: () => movingAvg(store.versionDelta.toArray(), 100),
      color: "#ff6b6b",
      label: "MA",
      width: 2,
    },
