...
export const scenarioCompositions: readonly ScenarioConfig[] = [
  { maxCount: 1, enemy: "bot-standing" },
  { maxCount: 1, enemy: "bot-moving" },
  { maxCount: 1, enemy: "bot-hunter", hunterReactionMs: 2000 },
  { maxCount: 1, enemy: "bot-hunter", hunterReactionMs: 1000 },
  { maxCount: 1, enemy: "bot-hunter" },
  { maxCount: 1, enemy: "frozen" },
  { maxCount: 1, enemy: "self-play" },
] as const;
