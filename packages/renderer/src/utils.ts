...
export class NestedArray<T extends ArrayLikeConstructor> {
  ...
  public static f64 = (batchLength: number, batchCount: number, seed?: ArrayLike<number>) =>
    new NestedArray(Float64Array, batchLength, batchCount, seed);

  public static f32 = (batchLength: number, batchCount: number, seed?: ArrayLike<number>) =>
    new NestedArray(Float32Array, batchLength, batchCount, seed);

  public static f16 = (batchLength: number, batchCount: number, seed?: ArrayLike<number>) =>
    new NestedArray(Float32Array, batchLength, batchCount, seed);

  public static u32 = (batchLength: number, batchCount: number, seed?: ArrayLike<number>) =>
    new NestedArray(Uint32Array, batchLength, batchCount, seed);

  public static i32 = (batchLength: number, batchCount: number, seed?: ArrayLike<number>) =>
    new NestedArray(Int32Array, batchLength, batchCount, seed);
