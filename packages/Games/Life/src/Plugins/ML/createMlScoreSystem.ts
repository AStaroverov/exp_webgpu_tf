...
import { Vehicle } from "../../GameEngine/ECS/Components/Vehicle";
import { MLState } from "./MlState";
import { GameDI } from "../../GameEngine/DI/GameDI";
import { Score } from "../../GameEngine/ECS/Components/Score";
import { RAYS_COUNT, RAY_BUFFER, RayHitType, TankInputTensor } from "../Pilots/Components/TankState";
import { PlayerRef } from "../../GameEngine/ECS/Components/PlayerRef";
import { findVehicleFromPart } from "../Pilots/Utils/snapshotTankInputTensor";
import { RigidBodyState } from "../../GameEngine/ECS/Components/Physical";
import { hypot } from "../../../../../lib/math";
import { VehicleController } from "../../GameEngine/ECS/Components/VehicleController";
