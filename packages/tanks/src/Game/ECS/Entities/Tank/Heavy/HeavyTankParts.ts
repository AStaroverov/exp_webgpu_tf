...
export const hullSet = createRectangleSet(14, 10, SIZE, PADDING);
export const turretHeadSet = createRectangleSet(9, 7, SIZE, PADDING);
export const turretGunSet = createRectangleSet(8, 2, SIZE, PADDING).map((set) => {
