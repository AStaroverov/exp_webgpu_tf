...
export function syncUnwrapTensor<T extends Float32Array | Uint8Array | Int32Array>(
  tensor: tf.Tensor,
): T {
  try {
...
export async function asyncUnwrapTensor<T extends Float32Array | Uint8Array | Int32Array>(
  tensor: tf.Tensor,
): Promise<T> {
  try {
